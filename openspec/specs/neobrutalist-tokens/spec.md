# Capability: Neo-Brutalist Design Tokens

## Purpose
Defines core visual tokens, color palettes, typography, borders, shadows, and global CSS utilities for the EventTrail Neo-brutalist UI design system.
